...
const spotifyID = '7t7eU85sSDHaw0ZAj9SXro'
    ...
    render(){
        ...
        return (
            <div id="home">
                ...
                <iframe title='spotify playlist' id="spotify" src={`https://open.spotify.com/embed/playlist/${spotifyID}`} width="250" height="380" frameBorder="0" allowFullScreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
